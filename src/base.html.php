...
<head>
    ...
    <meta name="twitter:site" content="@<?= e($twitter_username) ?>">
    <meta property="og:url" content="<?= e(sprintf("%s/%s", rtrim($site_url, '/'), ltrim($page_url, '/'))) ?>">
    ...
    <link rel="alternate" type="application/rss+xml" href="<?= e($feed) ?>" title="<?= e($site_title) ?>">
...
<header>
    ...
    <nav>
        ...
        <a href="https://github.com/<?= e($github_username) ?>">
            Projects
